...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'register') {
        ...
        if ($username && $first_name && $middle_name && $last_name && $email && $raw_password) {
            ...
            $verification_code = bin2hex(random_bytes(16)); // optional
            ...
            if ($result->num_rows > 0) {
                ...
                $stmt = $conn->prepare("INSERT INTO students (username, first_name, middle_name, last_name, email, password, verification_code, is_verified) VALUES (?, ?, ?, ?, ?, ?, ?, 1)");
