...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="student-header text-center">
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    <strong>Program:</strong> <?= htmlspecialchars($student['program'] ?? 'N/A') ?>
                </div>
                <div class="col-md-4">
                    <strong>Year Level:</strong> <?= htmlspecialchars($student['year_level'] ?? 'N/A') ?>
                </div>
                <div class="col-md-4">
                    <strong>Section:</strong> <?= htmlspecialchars($student['section'] ?? 'N/A') ?>
                </div>
            </div>
        </div>
