...
$student_id_str = $_SESSION['student_id']; // This is the string student_id (e.g., SN...)

// Get the integer id from students table
...
// ...then use $student_id_int for the enrollment insert...
if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($errors)) {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            $errors[] = "Failed to submit enrollment.";
        }
        $stmt->close();
    }
}
