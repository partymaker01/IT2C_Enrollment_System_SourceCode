                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="program" id="program" required>
                                ...
                                <option value="Bachelor of Science in Information Technology" <?= ($_POST['program'] ?? '') === 'Bachelor of Science in Information Technology' ? 'selected' : '' ?>>BS Information Technology</option>
                                <option value="Bachelor of Science in Computer Science" <?= ($_POST['program'] ?? '') === 'Bachelor of Science in Computer Science' ? 'selected' : '' ?>>BS Computer Science</option>
                                <option value="Bachelor of Science in Business Administration" <?= ($_POST['program'] ?? '') === 'Bachelor of Science in Business Administration' ? 'selected' : '' ?>>BS Business Administration</option>
                                <option value="Bachelor of Science in Hospitality Management" <?= ($_POST['program'] ?? '') === 'Bachelor of Science in Hospitality Management' ? 'selected' : '' ?>>BS Hospitality Management</option>
                                <option value="Bachelor of Science in Tourism Management" <?= ($_POST['program'] ?? '') === 'Bachelor of Science in Tourism Management' ? 'selected' : '' ?>>BS Tourism Management</option>
                                <option value="Associate in Computer Technology" <?= ($_POST['program'] ?? '') === 'Associate in Computer Technology' ? 'selected' : '' ?>>Associate in Computer Technology</option>
                            </select>
                        </div>
