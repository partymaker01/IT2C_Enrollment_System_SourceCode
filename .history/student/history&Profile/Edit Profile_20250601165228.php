...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $profilePicturePath = '/IT2C_Enrollment_System_SourceCode/student/uploads/' . $newFileName;
    ...
    // Check for duplicate email (fix: changed id to student_id)
    ...
    <form action="" method="POST" enctype="multipart/form-data"
      ...
      <div class="mb-4 text-center">
        <label for="profilePicture">
          <img src="/IT2C_Enrollment_System_SourceCode/student/uploads/<?= htmlspecialchars(basename($student['photo'])) ?>"
