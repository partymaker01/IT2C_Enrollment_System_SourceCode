          ...
          <?php if (!empty($students)): ?>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="view-student-details.php?id=<?= urlencode($students['student_id']) ?>" class="btn btn-primary btn-sm me-1" title="View details">
                  <i class="bi bi-eye"></i> View
                </a>
                <a href="edit-student.php?id=<?= urlencode($students['student_id']) ?>" class="btn btn-warning btn-sm me-1" title="Edit student">
                  <i class="bi bi-pencil-square"></i>
                  Edit
                </a>
                <button class="btn btn-danger btn-sm" title="Delete student" data-bs-toggle="modal" data-bs-target="#deleteModal" data-student-id="<?= htmlspecialchars($students['student_id']) ?>">
