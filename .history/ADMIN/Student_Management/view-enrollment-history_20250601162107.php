...
$result = $conn->query("SELECT e.id AS enrollment_id, s.student_id, s.first_name, s.last_name, ... FROM enrollments e JOIN students s ON e.student_id = s.student_id");
    ...
    <div id="enrollmentCards">
      ...
      if ($result && $result->num_rows > 0) {
          while ($enrollment = $result->fetch_assoc()) {
             ...
             $sqlSubjects = "SELECT subject_code, subject_description, instructor, grade, remarks 
