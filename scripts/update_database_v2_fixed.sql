-- First check if enrollment_periods table exists, if not create it
...
INSERT IGNORE INTO admin_settings (name, username, email, password, role, is_active) 
VALUES ('Admin User', 'admin', 'admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 1);
