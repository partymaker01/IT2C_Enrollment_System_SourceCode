...
$tickets = [
    'HD-2025-001' => [
        'studentName' => 'John Lester Lina',
        'category' => 'Enrollment Issue',
        'priority' => 'High',
        'priorityClass' => 'bg-danger',
        'status' => 'Open',
        'statusClass' => 'badge-open',
        'date' => '2025-05-20 10:15 AM',
        'message' => 'I am having trouble with my enrollment status...',
        'conversation' => '
            <p><strong>Student (JM Dela Cruz):</strong> Hi, my enrollment status is not updating.</p>
            <p><strong>Admin:</strong> We\'re checking your issue, please wait for updates.</p>
        ',
    ],
    'HD-2025-002' => [
        'studentName' => 'Joshua Santos',
        'category' => 'Document Upload',
        'priority' => 'Medium',
        'priorityClass' => 'bg-warning text-dark',
        'status' => 'In Progress',
        'statusClass' => 'badge-inprogress',
        'date' => '2025-05-18 02:30 PM',
        'message' => 'I uploaded my ID but status still pending.',
        'conversation' => '
            <p><strong>Student (Maria Santos):</strong> I uploaded my ID but status still pending.</p>
            <p><strong>Admin:</strong> We are verifying your documents.</p>
        ',
    ],
    'HD-2025-003' => [
        'studentName' => 'Jerick DC. Reyes',
        'category' => 'Payment',
        'priority' => 'Low',
        ...
        'message' => 'Payment confirmation not reflected yet.',
        'conversation' => '
            <p><strong>Student (Jose Rizal):</strong> Payment confirmation not reflected yet.</p>
            <p><strong>Admin:</strong> Payment verified, status updated.</p>
        ',
    ],
];
?>
